...
#same as network 4, but update parameters using pytorch optimizer, delete old apply_gradients function
#now include torch.nn.functional, change prepare_train_batch function
